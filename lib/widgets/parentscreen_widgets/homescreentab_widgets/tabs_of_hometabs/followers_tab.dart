...
class FollowersTabWidget extends ConsumerStatefulWidget {
  const FollowersTabWidget({super.key});

  @override
  ConsumerState<FollowersTabWidget> createState() => _ViewTabWidgetState();
}

class _ViewTabWidgetState extends ConsumerState<FollowersTabWidget> {
