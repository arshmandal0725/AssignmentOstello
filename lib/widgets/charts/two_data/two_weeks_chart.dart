...
class TwoWeeksChart extends StatelessWidget {
  const TwoWeeksChart({
    super.key,
    required this.weeklyData1,
    required this.weeklyData2,
  });
        ...
        return Padding(
          ...
          child: BarChart(
            BarChartData(
              ...
              barGroups: List.generate(weeklyData1.length, (i) {
                ...
                return BarChartGroupData(
                  ...
                  barRods: [
                    BarChartRodData(
                      ...
                      width: maxBarWidth *
                          0.8, // Adjust bar width for better visibility
                    ...
                    BarChartRodData(
                      ...
                      color: isSelected
                          ? Colors.red
                          : const Color(
                              0xFFC6C6C6), // Set the second dataset color to red
                      width: maxBarWidth *
                          0.8, // Adjust bar width for better visibility
                      borderRadius: BorderRadius.circular(4),
                      backDrawRodData: BackgroundBarChartRodData(
